...
use Slmatthew\Tetragram\Exceptions\InvalidBotTokenException;
...
class Request
{
     ...
     * @var array
     */
    private static array $actions_need_dummy_param = [
        'deleteWebhook',
        'getWebhookInfo',
        'getMe',
        'logOut',
     ...
     * @throws TelegramException
     */
    private static function mediaInputHelper(mixed $item, bool &$has_resource, array &$multipart): false|string
    {
