...
use Slmatthew\Tetragram\Commands\Command;
...
class Telegram
{
     ...
     * @var string
     */
    protected string $version = '0.83.0';
     ...
     *
     * @param     $external_pdo_connection  database object
     * @param string $table_prefix
     *
     * @return Telegram
     * @throws TelegramException
    ...
    public function isAdmin(int $user_id = null): bool
    {
        ...
        return !($user_id === null) && in_array($user_id, $this->admins_list, true);
    }
