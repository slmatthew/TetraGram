...
{
    public const string TYPE_PERSONAL_DETAILS = 'personal_details';

    public const string TYPE_PASSPORT = 'passport';

    public const string TYPE_DRIVER_LICENSE = 'driver_license';

    public const string TYPE_IDENTITY_CARD = 'identity_card';

    public const string TYPE_INTERNAL_PASSPORT = 'internal_passport';

    public const string TYPE_ADDRESS = 'address';

    public const string TYPE_UTILITY_BILL = 'utility_bill';

    public const string TYPE_BANK_STATEMENT = 'bank_statement';

    public const string TYPE_RENTAL_AGREEMENT = 'rental_agreement';

    public const string TYPE_PASSPORT_REGISTRATION = 'passport_registration';

    public const string TYPE_TEMPORARY_REGISTRATION = 'temporary_registration';

    public const string TYPE_PHONE_NUMBER = 'phone_number';
