...
use Slmatthew\Tetragram\Entities\CallbackQuery;
use Slmatthew\Tetragram\Entities\ChatJoinRequest;
use Slmatthew\Tetragram\Entities\ChatMemberUpdated;
use Slmatthew\Tetragram\Entities\ChosenInlineResult;
use Slmatthew\Tetragram\Entities\InlineQuery;
use Slmatthew\Tetragram\Entities\Message;
use Slmatthew\Tetragram\Entities\Payments\PreCheckoutQuery;
use Slmatthew\Tetragram\Entities\Payments\ShippingQuery;
use Slmatthew\Tetragram\Entities\Poll;
use Slmatthew\Tetragram\Entities\PollAnswer;
...
abstract class Command
{
     ...
     */
    public const string AUTH_SYSTEM = 'System';

    /**
     * Auth level for admin commands
     */
    public const string AUTH_ADMIN = 'Admin';
     ...
     * @var bool
     */
    protected bool $private_only = false;
